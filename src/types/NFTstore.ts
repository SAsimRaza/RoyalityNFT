...
export interface NFTstoreInterface extends utils.Interface {
  functions: {
    ...
    "setRoyality(uint8,uint256)": FunctionFragment;
    ...
    "typeToRoyalityFees(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "baseExt", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "typeToRoyalityFees",
    values: [BigNumberish]
  ): string;

  decodeFunctionResult(functionFragment: "approve", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "balanceOf", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "baseExt", data: BytesLike): Result;
...
export interface NFTstore extends BaseContract {
  ...
  functions: {
    ...
    baseExt(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    baseExt(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    idToItem(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    baseExt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
